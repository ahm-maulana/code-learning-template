<template>
  <footer class="bg-primary">
    <div class="px-4 pb-10 md:px-20">
      <div class="lg:px-20">
        <div
          class="-translate-y-1/2 space-y-4 rounded-lg bg-secondary py-8 px-10 text-center md:space-y-8"
        >
          <h3
            class="font-heading text-xl font-extrabold md:text-4xl lg:mx-auto lg:w-9/12"
          >
          ...
          <div class="flex flex-col gap-4 lg:flex-row lg:justify-center">
            <a
              href="#"
              class="transition-color bg-primary/50 p-4 font-semibold text-white duration-300 hover:bg-primary/30 lg:basis-1/5"
              >Try Yourself</a
            >
            <a
              href="#"
              class="transition-color flex items-center justify-center gap-6 bg-primary p-4 font-semibold text-white duration-300 hover:bg-primary/70 lg:basis-1/5"
            >
      ...
      <div class="space-y-10 md:space-y-4">
        <div
          class="-mt-24 flex flex-col items-center justify-center gap-10 md:flex-row md:justify-between md:border-b md:border-line md:py-4 lg:-mt-10 lg:px-20"
        >
            ...
            >
              <g clip-path="url(#clip0_24_477)">
                <g clip-path="url(#clip1_24_477)">
                  <rect width="32" height="32" rx="16" class="fill-secondary" />
                  <path
              ...
              <defs>
                <clipPath id="clip0_24_477">
                  <rect width="32" height="32" class="fill-primary" />
                </clipPath>
                <clipPath id="clip1_24_477">
                  <rect width="32" height="32" rx="16" class="fill-primary" />
                </clipPath>
              </defs>
            </svg>
            <h3
              class="text-3xl font-extrabold tracking-wider text-white group-hover:text-line"
            >
              Macode
            </h3>
          </a>
          <ul class="flex flex-col items-center gap-6 text-white md:flex-row">
            <li><a href="#" class="hover:text-line">Tutorials</a></li>
            <li><a href="#" class="hover:text-line">Resources</a></li>
            <li><a href="#" class="hover:text-line">Case Studies</a></li>
          </ul>
        </div>

        <div
          class="flex flex-col gap-10 md:flex-row md:items-center md:justify-between lg:px-20"
        >
          <ul
            class="flex justify-between gap-2 border-y border-line p-6 md:border-y-0 md:p-0 lg:gap-4"
          >
            <li>
              <a href="#" class="group">
                <svg
                ...
                >
                  <g clip-path="url(#clip0_19_303)">
                    <path
                      ...
                      class="fill-line group-hover:fill-line/50"
                    />
                  </g>
                  <defs>
          ...
          <div class="text-center text-white">
            © 2022 Copyright. <span class="text-secondary">Macode.io</span>
          </div>
        </div>
      </div>
    </div>
